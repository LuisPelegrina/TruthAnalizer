...
#rsync -vt --append-verify --info=progress2 -e 'ssh' lpelegri@sbndgpvm02.fnal.gov:/exp/sbnd/data/users/lpelegri/other_data/example_truth_data/analysis_output_truth_BNB_single_100_events.root .

#line to download 100k events using rsync
rsync -vt --append-verify --info=progress2 -e 'ssh' lpelegri@sbndgpvm02.fnal.gov:/exp/sbnd/data/users/lpelegri/other_data/example_truth_data/analysis_output_truth_BNB_single_100k_events.root .

#line to download 100 events using scp
#scp lpelegri@sbndgpvm02.fnal.gov:/exp/sbnd/data/users/lpelegri/other_data/example_truth_data/analysis_output_truth_BNB_single_100_events.root .

#line to download 100k events using scp
#scp lpelegri@sbndgpvm02.fnal.gov:/exp/sbnd/data/users/lpelegri/other_data/example_truth_data/analysis_output_truth_BNB_single_100k_events.root .
